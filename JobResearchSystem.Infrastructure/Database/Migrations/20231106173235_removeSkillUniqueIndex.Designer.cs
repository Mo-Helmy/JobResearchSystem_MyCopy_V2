...
namespace JobResearchSystem.Infrastructure.Database.Migrations
{
    ...
    [Migration("20231106173235_removeSkillUniqueIndex")]
    partial class removeSkillUniqueIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobResearchSystem.Domain.Entities.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("JobResearchSystem.Domain.Entities.Company", b =>
                {
                    b.HasOne("JobResearchSystem.Domain.Entities.Identity.ApplicationUser", "User")
                        .WithOne()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("JobResearchSystem.Domain.Entities.Identity.ApplicationUser", null)
                        .WithMany()
